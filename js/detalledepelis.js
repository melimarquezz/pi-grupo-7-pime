...
let verRecomendaciones = document.querySelector('.Recomendacion')
let recomendacionesDisplay = document.querySelector('#container')
verRecomendaciones.addEventListener('click',function(){
    ...
    fetch(url)
        ...
        .then(function (data) {
            ...
            let lista = document.querySelector(".vacio");
            
            for (let i = 0; i < 5; i++){
                lista.innerHTML += `<a href = "./detallepelicula.html?id=$recomedaciones[i].id}">
